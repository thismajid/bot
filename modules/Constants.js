export default {
    ...
    SONY_URL_WITH_RETRY: [
        'https://my.account.sony.com/central/management/?entry=device_password&origin_client_id=dfaa38ee-6f41-48c5-908c-2a338a183121',
    ...
    // ==================== Browser Limits ====================
    MAX_CONCURRENT_BROWSERS: parseInt(process.env.MAX_CONCURRENT_BROWSERS) || 7,
